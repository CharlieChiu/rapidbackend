...
public class SequenceAttachmentRenamer implements FileStoreStrategy{
    protected static AtomicLong squence = new AtomicLong(0l);
    ...
    public String store(FileUpload attachment) throws IOException{
        ...
        String seq = squence.incrementAndGet()+"";
        StringBuilder sb = new StringBuilder(64);
        sb.append(baseStoreDir).append("/").append(seq);
